...
/**
 * Memoized line chart that displays the user's completion history over the past 7 days.
 * The UI is only updated whenever the completionHistory prop changes.
 */
export const CompletionHistoryLineChart = memo(({ completionHistory }: CompletionHistoryLineChartProps) => {
